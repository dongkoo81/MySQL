...
"""
MySQL interactive Connection Timeout Test Script
======================================================
...
try:
    ...
    with connection.cursor() as cursor:
        ...
        log_message("Initial Process Details:")
        ...
        log_message("Now waiting without any query execution...")
...
NON_INTERACTIVE_SCRIPT = '''#!/usr/bin/env python3
"""
...
try:
    ...
    # MySQL 연결 설정 (Non-interactive mode)
    connection = mysql.connector.connect(
    host='your_aurora_endpoint',
    database='your_database',
    user='your_username',
