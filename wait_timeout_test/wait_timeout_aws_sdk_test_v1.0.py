...
# AWS 리소스 설정
AWS_REGION = "ap-northeast-2"  # 서울 리전  # 사용자 변수
DB_CLUSTER_IDENTIFIER = "mysql-test-cluster23"    # 사용자 변수
...
VPC_SECURITY_GROUP_ID = "sg-0ec74c9d52681276f"   # 사용자 변수
DB_SUBNET_GROUP_NAME = "my-dk-app-sbg"  # 사용자 변수

# Bastion 서버 설정
BASTION_NAME = "mysql-test-bastion23"   
INSTANCE_TYPE = "t3.micro" 
SUBNET_ID = "subnet-006ee28d32d4c1635"    # 사용자 변수
SECURITY_GROUP_ID = "sg-0ec74c9d52681276f"   # 사용자 변수
